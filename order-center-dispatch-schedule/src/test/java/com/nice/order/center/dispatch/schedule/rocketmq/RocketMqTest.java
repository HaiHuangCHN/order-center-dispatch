...
import com.nice.order.center.dispatch.schedule.OrderCenterDispatchScheduleApplication;
...
@SpringBootTest(classes = {OrderCenterDispatchScheduleApplication.class})
@Slf4j
